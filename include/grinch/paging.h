...
#define PAGE_FLAGS_RX		(RISCV_PTE_FLAG(V) | RISCV_PTE_FLAG(G) | RISCV_PTE_FLAG(R) | RISCV_PTE_FLAG(X))
#define PAGE_FLAGS_RW		(RISCV_PTE_FLAG(V) | RISCV_PTE_FLAG(G) | RISCV_PTE_FLAG(R) | RISCV_PTE_FLAG(W))
#define PAGE_FLAGS_RWXU		(RISCV_PTE_FLAG(V) | RISCV_PTE_FLAG(G) | RISCV_PTE_FLAG(R) | RISCV_PTE_FLAG(W) | RISCV_PTE_FLAG(X) | RISCV_PTE_FLAG(U))
#define PAGE_FLAGS_RO		(RISCV_PTE_FLAG(V) | RISCV_PTE_FLAG(G) | RISCV_PTE_FLAG(R))
